# Week 1
## Learn and Implement DSA (JAVA) 

This week's goal are as following:

- **Java Introduction**: (JVM, variable storage, Flow of Program in Java)
- **Searching**: Linear, Binary (very important)
- **Sorting**: Bubble, Selection, Insertion, Cycle
- **Strings**: String Functions, StringBuilder
